...
def main():
    ...
    name = input("Name of playlist you would like to arrange by tempo: ").strip()
    ...
    arrangement = input("Would you like to arrange this playlist in\n"
    ...
    if arrangement != str(1) and arrangement != str(2):
        while arrangement != str(1) and arrangement != str(2):
            arrangement = input("Please enter a 1 or 2: ").strip()

    # Have user choose name of new playlist
    new_name = input("Name of new playlist: ").strip()
